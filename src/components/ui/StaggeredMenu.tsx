      ...
      className={`sm-scope z-50 ${
        isFixed
          ? open
            ...
            : "fixed top-0 left-0 z-50 h-[5.5rem] w-screen overflow-visible"
          : "h-full w-full"
      }`}
    >
      <div
      ...
      >
        ...
        >
          <div className="sm-logo flex items-center select-none pointer-events-auto" aria-label="Logo">
            <Link href="/" className="inline-flex" onClick={() => open && closeMenu()}>
              <img
        ...
        <aside
          ...
          ref={panelRef}
          className={`staggered-menu-panel z-10 flex flex-col bg-white p-[6em_2em_2em_2em] backdrop-blur-[12px] pointer-events-auto overflow-y-auto ${
            isFixed
